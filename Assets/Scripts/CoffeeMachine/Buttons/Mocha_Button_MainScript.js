...
function Interact ()
{
	if (( PScript.HasMug == true && Nozzel_Coffee.GetComponent("Coffee_Nozzel_MainScript").HasFulled == false && Quantity >= 3 && Nozzel_Coffee.GetComponent("Coffee_Nozzel_MainScript").IsFilling == false))
	{
		GetComponent.<AudioSource>().PlayOneShot(ButtonSound);
		Nozzel_Coffee.GetComponent("Coffee_Nozzel_MainScript").FillMocha();
